...
<head>
  ...
  <title>Goldilocks Bakeshop — Fresh from the Oven</title>
  <meta name="description" content="Goldilocks-inspired bakeshop. Fresh cakes, pastries, breads, and party treats. Order online or pick up in-store." />
  <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='0.9em' font-size='90'%3E%F0%9F%8D%9E%3C/text%3E%3C/svg%3E">
  <style>
    :root{
      --accent:#b77a2a; /* gold/brand */
      --muted:#666;
      --bg:#fff8f0;
      --card:#ffffff;
    ...
    *{box-sizing:border-box}
    ...
    header{position:sticky;top:0;background:linear-gradient(180deg,rgba(255,255,255,0.9),rgba(255,255,255,0.7));backdrop-filter: blur(6px);border-bottom:1px solid rgba(0,0,0,0.06);z-index:40}
    ...
    .brand .logo{width:44px;height:44px;border-radius:8px;background:linear-gradient(135deg,#fff, #FFEFD5);display:flex;align-items:center;justify-content:center;box-shadow:0 4px 10px rgba(183,122,42,0.12)}
    nav a{color:inherit;text-decoration:none;padding:.45rem .6rem;border-radius:8px}
    ...
    .hero .hero-card{background:linear-gradient(180deg,#fff,#fff8f0);padding:1rem;border-radius:14px;box-shadow:0 10px 30px rgba(0,0,0,0.06)}

    /* Products */
    .grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1rem}
    .card{background:var(--card);border-radius:12px;padding:1rem;box-shadow:0 8px 20px rgba(0,0,0,0.05);display:flex;flex-direction:column}
